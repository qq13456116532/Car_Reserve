...
public class CustomerServiceImpl implements ICustomerService {
    ...
    private ServerResponse createCustomer(Customer customer) {
    ...
    @Override
    public ServerResponse getCusById(String id) {
    ...
    private String createCustomerId() {
        ...
        return new String(String.valueOf(Long.valueOf(format) + (num++)));
    }
